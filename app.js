...
const dataload = () => {
  ...
  setTimeout(() => {
    sec_title.innerHTML = " INDONESIA <br>COCONUT <br>SUPPLIER";
  ...
  setTimeout(() => {
    sec_title.innerHTML = " INDONESIA <br>CHARCOAL <br>SUPPLIER";
  ...
  setTimeout(() => {
    sec_title.innerHTML = " INDONESIA <br>BRIQUETTE <br>SUPPLIER";
    h6_dot[1].classList.remove("head_dots_main");
    h6_dot[2].classList.remove("head_dots_main");
